...
function VisGeneralFunc() {
    const [dropDownVal, setDropDownVal] = useState("hallo")
    const [prevDropDownVal, setPrevDropDownVal] = useState(dropDownVal)
    ...
    },[dropDownVal, prevDropDownVal, setPrevDropDownVal])
    function xAxisDropDown(k){
        setDropDownVal(k.replace("#/", ""))
    }
    return (
        <div className="row">
        <div id="test">
            ...
            <div className="column-3" >
                ...
                <DropdownButton id="try" onSelect={(k) => xAxisDropDown(k)} title={dropDownVal} className="select-wrapper">
                        <Dropdown.Item id="a" href="#/a">a</Dropdown.Item>
