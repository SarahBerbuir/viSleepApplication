...
export class VisGeneral extends Component {
    static propTypes = {
    ...
    componentDidMount() {
        ...
        function weekParam(ouraDataFormatted) {
            var xAxis = "week"
            var kw = 0
            var weekNumbers = {}
            var actualKW = 0
        ...
        document.getElementById("yAxisButton").onclick = function(){
                ...
                $("#recommChoice").val("customized")
                if(xAxisAttr =="week"){
                    updateData(weekParam(ouraDataFormatted))
                } else{
                    updateData(ouraDataFormatted)
                }
            };
      ...
      /*
      <div id="recomm">
                        <select id="recommChoice" input="dropdown" >
                        <option id="default" value="customized">default x-axis: ., y-axis: ., color: ., radius: . </option> 
                        <option value="SleepActivityAcitivity">xAxis: SleepScore, yAxis: ActivityScore, radius: ActivityScore</option>
                        <option value="periodMode"> Period </option>

                        </select>
                        <button text="Choose" id="recommButton" className="AxisButton" > Choose</button>
                    </div>
      */
    ...
    render() {
        return  <div className="row">
            <div id="test">
                ...
                <DropdownButton id="dropdown-basic-button" onSelect={(k) => console.log(k)} title="Dropdown button">
                    ...
                    <div id="yAxis" className="dropdownDiv">
                        <h1>Timeline</h1>
                        <select id="timeChoice" input="dropdown" className="select-wrapper">
